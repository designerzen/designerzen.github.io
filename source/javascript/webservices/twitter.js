    ...
    callback: function(data) {
      ...
      while(n < x) {
        ...
        if (parseLinks) {
          ...
          //EDIT BY ZEN : moved time before tweet as is floated right
          if (printTime) {
            if (permalinks) {
              op += '<div class="timePosted">';
              op += '<a alt="'+( newDate.toString() )+'" href="' + permalinksURL[n] + '">';
        ...
        if (showInteractionLinks) {
          op += '<ul class="interact"><li><a href="https://twitter.com/intent/' +
              ...
              'Reply</a></li><li><a href="https://twitter.com/intent/retweet?tweet_id=' +
              tids[n] + '" class="twitter_retweet_icon"' + (targetBlank ? ' target="_blank">' : '>') + 'Retweet</a></li><li>' +
              '<a href="https://twitter.com/intent/favorite?tweet_id=' +
              tids[n] + '" class="twitter_fav_icon"' + (targetBlank ? ' target="_blank">' : '>') + 'Favorite</a></li></ul>';
        }
